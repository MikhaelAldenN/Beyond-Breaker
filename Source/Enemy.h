...
public:
    ...
    // [GAMEBREAKER FEATURES] - Kept for compatibility
    ...
    // [GAMEBREAKER] Getters for Copy Logic
    ...
    // [GAMEBEYOND FEATURES] - Scale support
...
private:
    ...
    float m_projectileSpeed = 7.0f;   // Speed of the ball (GameBreaker default)
